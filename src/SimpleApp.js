...
function SimpleApp() {
  ...
  return (
    <div className="bg-cyber-dark text-white min-h-screen">
      ...
      <motion.section id="intensive" className="py-20 bg-gradient-to-br from-cyber-dark via-cyber-gray to-cyber-dark relative">
        <div className="absolute inset-0">
      ...
      <motion.section id="testimonials" className="py-20 bg-cyber-gray relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-brutal font-black text-cyber-cyan neon-text mb-6">
